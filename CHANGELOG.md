...
- License: GPL-3.0-or-later (previously MIT). Versions already
  published under MIT remain available under MIT; this and later
  versions are GPL. The CLI is usable from any program regardless —
  running it as a subprocess carries no license obligations.
